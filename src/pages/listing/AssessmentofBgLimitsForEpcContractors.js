...
const AssessmentofBgLimitsForEpcContractors = () => {
                  ...
                  <Modal>
                    <Card style={{ width: '300px', height: '300px' }}>
                      <Card.Body>
                        ...
                        <label className="">Adderess</label>
                        <input type="text" className="mt-0"/><br/><br/>
                ...
                <Card>
                  <Card.Body>
                    ...
                    <div className="card-details">
                      ...
                      Assessment of BG Limits for EPC Contractors
                      </Card.Title>
...
export default AssessmentofBgLimitsForEpcContractors;
